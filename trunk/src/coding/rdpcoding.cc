...
SegmentData RDPCoding::decode(vector<BlockData> &blockDataList,
...
block_list_t RDPCoding::getRequiredBlockSymbols(vector<bool> blockStatus,
...
uint32_t RDPCoding::getBlockCountFromSetting(string setting) {
...
uint32_t RDPCoding::getParameters(string setting) {
	uint32_t n;
