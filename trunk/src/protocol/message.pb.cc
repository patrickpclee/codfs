...
void protobuf_AssignDesc_message_2eproto() {
  ...
  static const int PutObjectInitRequestPro_offsets_[2] = {
  ...
  PutSegmentInitPro_descriptor_ = file->message_type(9);
  ...
  PutSegmentEndPro_descriptor_ = file->message_type(10);
