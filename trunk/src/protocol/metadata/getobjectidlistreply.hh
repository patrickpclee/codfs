...
public:
	 ...
	 *
	 */
	GetObjectIdListReplyMsg(Communicator* communicator, uint32_t requestId, uint32_t mdsSockfd, const vector<uint64_t> &objectIdList, const vector<uint32_t> &primaryList);
