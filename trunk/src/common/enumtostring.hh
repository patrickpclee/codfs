...
public:
  ...
  static const char * toString( MsgType en ) {
    switch( en ) {
      ...
      case GET_OBJECT_READY: return "GET_OBJECT_READY";
      case GET_OBJECT_REPLY: return "GET_OBJECT_REPLY";
      ...
      case GET_SEGMENT_INIT_REPLY: return "GET_SEGMENT_INIT_REPLY";
      case GET_SEGMENT_INIT_REQUEST: return "GET_SEGMENT_INIT_REQUEST";
      case GET_SEGMENT_READY: return "GET_SEGMENT_READY";
