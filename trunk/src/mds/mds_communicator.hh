...
public:
    ...
    uint32_t requestCache(uint64_t segmentId, HotnessRequest req,
     ...
     */
    void replyRenameFile(uint32_t requestId, uint32_t connectionId,
    ...
    void replyUploadSegmentAck(uint32_t requestId, uint32_t connectionId,
            uint64_t segmentId);

    void replySegmentCodingInfo(uint32_t requestId, uint32_t connectionId,
