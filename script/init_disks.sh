...
do
	...
	echo "ssh -t -t root@$targetip 'unlink $osdblock; rm -rf $osdblock; umount /data; mke2fs -T ext2 -U $uuid /dev/sdb1 && mount -a; mkdir -p /data/osd_block; chown ncsgroup:ncsgroup /data/osd_block; ln -s /data/osd_block $osdblock;'" >> initdisks.job
done
